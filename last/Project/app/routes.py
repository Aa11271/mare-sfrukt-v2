# routes.py
from flask import Flask, abort, jsonify, render_template, request, url_for, flash, redirect, send_file
...
from .extensions import db, case
...
def configure_routes(app):
    ...
    @app.route('/Users/nesto/Desktop/Programiranje/last/Project/app/templates/bcg.jpg')
    def serve_image():
        return send_file('/Users/nesto/Desktop/Programiranje/last/Project/app/templates/bcg.jpg')

    @app.route('/favedit.ico')
    def favicon():
        return send_file('/Users/nesto/Desktop/Programiranje/last/Project/app/templates/favedit.ico')
    ...
    def create_small_storage():
     if request.method == 'POST':
        ...
        if main_storage and main_storage.quantity >= quantity:
            ...
            flash('New small storage created!', 'Small Storage created Succesfully!') #poruka za small storage uspesno
            return redirect(url_for('create_small_storage'))
        else:
            # Not enough quantity in main storage to create small storage
            flash('Not enough quantity in main storage!', 'Not enough Main Storage Quantity!') #poruka za small storage neuspesno
